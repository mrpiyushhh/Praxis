...
function renderArchiveList() {
  ...
  archived.forEach(task => {
    ...
    row.style.cssText = 'background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); backdrop-filter: blur(28px); transition: background 0.2s ease, border-color 0.2s ease;'
